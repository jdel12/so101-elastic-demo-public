...
k8s manifests (`infra/k8s/`), rebuild scripts (`scripts/rebuild/`), and
...
The rebuild scripts use `scripts/rebuild/config.env` for credentials and
endpoints. Copy the example and edit:
